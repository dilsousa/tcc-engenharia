...
\include{lista-de-abreviaturas-e-siglas}
...
\include{aws}
\include{gcp}
\include{outras-plataformas-em-nuvem}

\part{Software}

\include{microservicos}
\include{escalabilidade}
\include{balanceador-de-carga}

\part{Integração de infraestrutura e software}

\include{desacoplamento-da-solucao}
